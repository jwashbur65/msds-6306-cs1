...
#Output the Kable of the Median ABV by State
...
#create the facets for the graph to make the data more readable.
...
#Output the Kable of the computed IBU Median by State
