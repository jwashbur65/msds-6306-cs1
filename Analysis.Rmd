...
Cheun Chugs & Cheers (henceforth referred to by its ticker symbol CCAC, or simply "the client") is an American hospitality company. Founded and based in Reno, NV, by eponymous owner Jacquelyn Cheun, CCAC owns and operates a number of popular bars along the East Coast, including:
...
# Nothing major to clean. Create working copies.
...
Any instances of NA are counted and reported in this table, which shows that only the Alcohol By Volume (ABV) and IBU columns contain NAs, with 62 and 1,005, respectively. None of the other columns have missing values.
...
abv_ibu_scatter <- merged_beers_raw %>% ggplot(aes(x = ABV, y = IBU)) + 
