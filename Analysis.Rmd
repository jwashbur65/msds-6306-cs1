...
CCAC requested information on the states with the most alcoholic and most bitter beers available, indicating that beers high in ABV and IBU content are likely popular among current consumers. With one exception, the following states are notable for being within or tied (indicated in the tables below by "=") in the top ten for both:
