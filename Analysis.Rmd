...
Of the states that are in both top ten lists for ABV and IBU, California, Indiana, Massachusetts, and Texas also appear in the top ten for the number of breweries, beers, and styles per state. 
...
kable(sorted_abv_agg)
kable(sorted_ibu_agg)
