...
abv_median_bars <- abv_state_median %>% ggplot(aes(x = reorder(State, desc(State)), y = Median_ABV)) +
  geom_bar(stat = "identity") +
  coord_flip() + 
...
ibu_median_bars <- ibu_state_median %>% ggplot(aes(x = reorder(State, desc(State)), y = Median_IBU)) +
  geom_bar(stat = "identity") +
  coord_flip() + 
